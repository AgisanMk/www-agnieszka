      ...
      <div className="d-flex justify-content-between align-items-start">
        <div>
          <div className="d-flex justify-content-between">
            <div>
              <h4 className="mb-2">{item.nameProject} - <a href="https://{item.linkProject}" className="text-primary mb-0">{item.linkProject}</a></h4>
            </div>
          ...
          <p><a href="https://{item.linkRepo1}" className="text-primary">{item.linkRepo1}</a></p>
          <p><a href="https://{item.linkRepo2}" className="text-primary">{item.linkRepo2}</a></p>
          <p><a href="https://{item.linkRepo3}" className="text-primary">{item.linkRepo3}</a></p>
        </div>
      </div>
    </div>
);
